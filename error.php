...
$sql = "select * from IPerror where State ='$ip' limit 1";
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center w-75 m-auto">
                            <h4 class="text-dark-50 text-center mt-0 font-weight-bold">Like_Girl 3.0</h4>
                            <p class="text-muted">善语结善缘 恶语伤人心</p>
                            <p class="text-muted mb-4">
                                <span class="badge badge-danger-lighten">封禁原因：
                                <?php if ($fjyy['text']) { ?><?php echo $fjyy['text']; ?><?php } else { ?>您的IP未被封禁 <?php } ?>
                                </span>
